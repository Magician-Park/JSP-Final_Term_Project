        ...
        <div class="news-contents wrapper">
            ...
            <article>
                <header class="post-info">
                    <h2 class="post-title">중형 세단</h2>
                    <p class="post-date"><%=bbs.getDate().substring(5, 7)%>/<%=bbs.getDate().substring(8, 10)%> <span><%=bbs.getDate().substring(0, 4)%></span></p> <!-- 만든 날짜 -->
                </header>
                <a href="bulletinboard-01.jsp"><img src="/images/K5.png" alt="중형차 게시글 1"></a>
                <a href="bulletinboard-02.jsp"><img src="/images/malli.png" alt="중형차 게시글 2"></a>
                <a href="bulletinboard-03.jsp"><img src="/images/SM6.png" alt="중형차 게시글 3"></a>
                <a href="bulletinboard-04.jsp"><img src="/images/sonata.png" alt="중형차 게시글 4"></a>
                <a href="bulletinboard-05.jsp"><img src="/images/G70.png" alt="중형차 게시글 5"></a>
                <a href="bulletinboard-06.jsp"><img src="/images/A5.png" alt="중형차 게시글 6"></a>
                <a href="bulletinboard-07.jsp"><img src="/images/Y.png" alt="중형차 게시글 7"></a>
            </article>
        </div><!-- news-contents -->
